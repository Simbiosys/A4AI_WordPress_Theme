...
<?php $post_num=0; ?>
            ...
            <div id="organize_by_posts">
                ...
                <h2 class="Title">Members Research</h2>
                <p>A4AI members produce a large amount of high-quality research on affordability related matters. On this page, we highlight relevant and timely pieces of member research - as well as research from other leading organisations - which we believe will be of value to our community. </p><br /><br />

                <?php
				 $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				 query_posts("cat=63&paged=$paged&orderby=date&order=DESC");

                if($_GET['sort'] == 'title') query_posts("cat=63&paged=$paged&orderby=title&order=ASC");

				if($_GET['sort'] == 'date') query_posts("cat=63&paged=$paged&orderby=date&order=DESC");

				if($_GET['sort'] == 'relevance') query_posts("cat=63&paged=$paged&orderby=comment_count&order=DESC");
                    ...
                    <article <?php post_class() ?> id="post-<?php the_ID(); ?>">
                        ...
                        <div class="Content">
                            ...
                            <div class="entry">
                                ...
                                <?php } ;
								if ($institution != '') {?>
                                <h6 class="metadata">Institution: <?php echo $institution ?></h6>
                                <?php } ?>
