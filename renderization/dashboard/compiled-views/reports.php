...
'funcs' => Array(
    ...
    return '<link rel="stylesheet" href="'.htmlentities((string)((isset($in['root']) && is_array($in)) ? $in['root'] : null), ENT_QUOTES, 'UTF-8').'/renderization/dashboard/css/dragula.min.css" />
<link rel="stylesheet" href="'.htmlentities((string)((isset($in['root']) && is_array($in)) ? $in['root'] : null), ENT_QUOTES, 'UTF-8').'/renderization/dashboard/css/reports.css" />
        ...
        <section class="report-item-body">
          <header class="report-item-header">
            <nav class="report-item-actions">
              <a href="javascript:void(0)" class="report-item-view" title="Anchor to the previous block" data-anchor="'.htmlentities((string)((isset($in['ID']) && is_array($in)) ? $in['ID'] : null), ENT_QUOTES, 'UTF-8').'" data-anchored="'.htmlentities((string)((isset($in['meta-box-anchor']) && is_array($in)) ? $in['meta-box-anchor'] : null), ENT_QUOTES, 'UTF-8').'">
...
<script src="'.htmlentities((string)((isset($in['root']) && is_array($in)) ? $in['root'] : null), ENT_QUOTES, 'UTF-8').'/renderization/dashboard/js/dragula.min.js"></script>
<script src="'.htmlentities((string)((isset($in['root']) && is_array($in)) ? $in['root'] : null), ENT_QUOTES, 'UTF-8').'/renderization/dashboard/js/reports.js"></script>
