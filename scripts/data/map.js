(function() {
  ...
  loadCountryDetail = function(code) {
    ...
    global.ref.ranking_this_country_label.innerHTML = "out of " + (global.minMaxDeveloping.count + global.minMaxEmerging.count) + " countries";
    ...
    global.ref.ranking_mean_label.innerHTML = "out of " + groupNumber + " countries";
