...
<?php $post_num=0; ?>
            ...
            <div id="organize_by_posts">
                ...
                <?php
				 ...
				 query_posts("cat=60&paged=$paged&orderby=date&order=DESC");

                if($_GET['sort'] == 'title') query_posts("cat=60&paged=$paged&orderby=title&order=ASC");

				if($_GET['sort'] == 'date') query_posts("cat=60&paged=$paged&orderby=date&order=DESC");

				if($_GET['sort'] == 'relevance') query_posts("cat=60&paged=$paged&orderby=comment_count&order=DESC");
